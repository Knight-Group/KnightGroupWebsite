# Knight Group Authority Plan

This plan focuses on the pages Google is already surfacing in Search Console and the local organizations that best match Knight Group's Safety Harbor and Pinellas County service footprint.

## Verified NAP

- Business: Knight Group Handyman Services LLC
- Phone: (813) 649-3341
...
| Query / intent cluster | Primary landing page | Secondary landing page | Reason |
| --- | --- | --- | --- |
| General handyman / home repair | https://www.knightgroup.com/Services/handyman | https://www.knightgroup.com/Services/general-repairs | Broad local-intent entry point and strongest handyman fit |
| Small job carpenter near me / carpentry services | https://www.knightgroup.com/Services/carpentry-framing | https://www.knightgroup.com/Services/general-repairs | Matches carpenter and trim/repair intent already earning impressions |
| Interior / exterior painting contractor Pinellas County | https://www.knightgroup.com/Services/painting-finishing | https://www.knightgroup.com/galleries | Paint query intent is already present in GSC and needs a dedicated destination |
| Home renovation company Pinellas County | https://www.knightgroup.com/Services/home-renovations | https://www.knightgroup.com/pricing | Renovation intent is already showing impressions |
| Plumbing repair / fixture swap / handyman plumbing | https://www.knightgroup.com/Services/plumbing-services | https://www.knightgroup.com/booking | Keeps plumbing-intent users off irrelevant results and into the right page |
| Emergency repair intent | https://www.knightgroup.com/Services/emergency-services | https://www.knightgroup.com/contact | Strong fit for urgent repair and response-time messaging |
| Quote / estimate intent | https://www.knightgroup.com/booking | https://www.knightgroup.com/contact | Best conversion route for directory profiles and calls to action |

## External Citation Stack
...
These were verified during this pass and should be prioritized ahead of low-value directory spam.

| Organization | Evidence | Action | Link target |
| --- | --- | --- | --- |
| Safety Harbor Chamber of Commerce | Join page and Find a Member directory are visible on site | Join, complete member profile, and use booking plus homepage in profile assets | Homepage + booking |
| Safety Harbor Chamber directory | https://business.safetyharborchamber.com/list | Claim member listing once chamber membership is active | Homepage |
| Tarpon Springs Chamber of Commerce | Site shows member directory and live member listings | Join or request listing if service-area fit is acceptable | Service-areas or handyman |
| Tarpon Springs Chamber directory | https://www.tarponspringschamber.org/list | Deep-link to service-areas or handyman if listing copy allows it | Service-areas |
| Central Pinellas Chamber | Membership inquiry page and business directory are visible | Join and build directory profile | Homepage + booking |
| Central Pinellas Chamber directory | https://www.centralchamber.biz/the-chamber/business-directory | Use booking or contact as the main CTA destination | Booking |
| Upper Tampa Bay Chamber of Commerce | Site title and chamber/member signals verified at https://www.utbchamber.com/ | Review membership and directory options on-site | Service-areas or handyman |

## Partner Link Targets

These are the best non-directory partners for service-page links.

| Partner type | Best landing page | Why it fits |
| --- | --- | --- |
| Realtors and home stagers | Painting-finishing, general-repairs | Helps with pre-listing repairs and cosmetic refresh work |
| Property managers | General-repairs, handyman, emergency-services | Ongoing punch-list and turnover repair work |
| Water-damage / restoration companies | General-repairs, emergency-services | Repair follow-up after mitigation work |
| Window, door, and flooring showrooms | Doors-windows, home-renovations, carpentry-framing | Natural referral overlap |
| Local plumbers and electricians | Handyman, general-repairs | Overflow for non-licensed or mixed-scope handyman tasks |
| Cabinet, trim, and millwork shops | Carpentry-framing, custom-projects | Strong fit for finish-work referrals |

## Recommended Anchor Themes

Keep anchor text natural and varied. Do not overuse exact-match anchors.

| Landing page | Preferred anchor themes |
| --- | --- |
| /Services/general-repairs | general repair services, home repair help, Pinellas home repairs |
| /Services/carpentry-framing | carpentry services, small job carpenter, trim and framing repairs |
| /Services/painting-finishing | interior painting handyman, painting and finishing, wall repair prep |
| /Services/home-renovations | small renovation contractor, room update work, handyman renovations |
| /Services/plumbing-services | handyman plumbing repairs, fixture replacement, minor plumbing help |
| /booking | request a free estimate, book a repair estimate, handyman quote |

## Internal Authority Actions Already Aligned

These items should stay in place because they help Google understand the core page set.

- Raw HTML crawl hubs now exist on all 18 core sitemap pages.
- Gallery category cards now link directly to service pages instead of acting like dead-end blurbs.
- Sitemap is narrowed to the 18 core pages instead of wasting focus on low-value policy URLs.

## External Execution Order

1. Finish top-tier business profiles: Google Business Profile, Bing Places, Apple Business Connect, Yelp, BBB, MapQuest.
2. Join or renew the local chambers that most closely match the Safety Harbor and Pinellas footprint: Safety Harbor first, Central Pinellas second, Tarpon Springs third, Upper Tampa Bay fourth.
...
- Do not create a batch of thin city pages before the current core set indexes.
- Do not point every citation or partner link to the homepage. Spread them across booking and the service pages above.
- Do not describe Knight Group as a general contractor or mix Knight Logics positioning into listings.
- Do not chase low-quality bulk directory spam ahead of chambers, major platforms, and real local partners.
