...
def main() -> int:
    pages = {
        "home-watch-pinellas.html": page(
            ...
            title="Home Watch Pinellas County | Snowbird Property Checks",
        ...
        "home-watch-pricing.html": page(
            ...
            description="Pinellas County Home Watch pricing: weekly $329/month, biweekly $189/month, or a one-time $125 vacant-house check, with a photo report after each visit.",
        ...
        "home-watch-checklist.html": page(
            ...
            title="Florida Home Watch Checklist | What We Check",
            description="See the Florida Home Watch checklist Knight Group uses for HVAC, humidity, visible leaks, entry points, mail, and a photo report after each scheduled visit.",
        ...
        "florida-snowbird-departure-checklist.html": page(
            ...
            description="Use this Florida snowbird departure checklist for water, thermostat, mail, storm prep, access, and insurance steps before leaving your seasonal home.",
