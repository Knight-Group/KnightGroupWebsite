...
CITY_PRIMARY_QUERY: dict[str, str] = {
    ...
    "dunedin": "dunedin handyman",
    "palm-harbor": "palm harbor handyman",
    "largo": "handyman largo",
    "oldsmar": "oldsmar handyman",
    "tarpon-springs": "tarpon springs handyman",
    "seminole": "seminole handyman",
    "st-petersburg": "handyman services pinellas county",
    "tampa": "handyman tampa fl",
    "town-n-country": "handyman tampa fl",
    "westchase": "handyman westchase fl",
    "citrus-park": "handyman citrus park fl",
    "carrollwood": "handyman carrollwood fl",
    "northdale": "handyman northdale fl",
    "egypt-lake-leto": "landlord handyman tampa",
    "temple-terrace": "handyman temple terrace fl",
    "holiday": "handyman holiday fl",
    "trinity": "handyman trinity fl",
    "new-port-richey": "handyman new port richey fl",
    "elfers": "handyman elfers fl",
    "seven-springs": "handyman seven springs fl",
    "jasmine-estates": "handyman jasmine estates fl",
    "beacon-square": "handyman beacon square fl",
    "port-richey": "handyman port richey fl",
    "land-o-lakes": "handyman land o lakes fl",
}

COUNTY_PRIMARY_QUERY: dict[str, str] = {
    "pinellas": "handyman pinellas county",
    "hillsborough": "handyman hillsborough county",
    "pasco": "handyman pasco county fl",
}
