"""GSC-informed content blocks to append on service pages (Jun 2026 export)."""
...
<p>Knight Group handles the repairs that pile up after everyday wear, Florida humidity, and small water events — the kind of work behind searches like <strong>knights home repair</strong> and <strong>handyman company pinellas</strong>. We are registered, insured, and based in Safety Harbor with steady coverage across the county.</p>

<h3>Drywall patching, holes, and texture matching</h3>
<ul>
<li>Ceiling and wall patches after leaks, HVAC work, or fixture changes</li>
<li>Texture blending so repairs disappear after paint</li>
<li>Backer board and substrate fixes before tile or vanity installs</li>
</ul>

<h3>Gutter installation and repair in Safety Harbor</h3>
...
<p>Searches for <strong>carpentry services near me</strong> in our market usually mean trim work, shelving, a warped door frame, or repair carpentry after moisture — not full new construction. Knight Group provides handyman-level carpentry across Safety Harbor, Clearwater, and Pinellas County.</p>

<h3>Trim, molding, and baseboard installation</h3>
<ul>
<li>Baseboard, casing, and shoe molding repair or replacement</li>
<li>Door jamb and strike plate corrections</li>
<li>Custom shelving, closet rods, and laundry shelving</li>
<li>Deck board replacement and exterior wood repair (scope-dependent)</li>
</ul>
...
<p>Paint is often the fastest way to make a repair disappear — but only if prep is done right. Knight Group handles room refreshes, trim painting, and touch-ups across Safety Harbor and Pinellas County with the same attention to punch-list detail as our repair work.</p>

<h3>Room painting, trim, and touch-ups</h3>
<ul>
<li>Interior walls and ceilings after drywall or plaster repair</li>
<li>Trim, doors, and cabinet touch-ups (not full spray-shop refinishing)</li>
<li>Exterior fascia, soffit, and spot painting where prep allows</li>
<li>Caulk, fill, sand, prime, and paint sequences that last in Florida humidity</li>
</ul>

<h3>Prep work that makes paint last</h3>
<p>We patch holes, match texture where feasible, sand glossy surfaces, and prime stains before topcoat. Homeowners comparing quotes should ask what prep is included — that is where cheap paint jobs fail in coastal humidity.</p>
""",
    "home-renovations": """
<h2>Home renovations and room updates in Pinellas County</h2>
<p>Queries like <strong>general contractors pinellas county</strong> and <strong>construction company pinellas county</strong> often come from homeowners who need a smaller update — not a full ground-up build. Knight Group fits <strong>handyman-scale renovations</strong>: bathroom refreshes, laundry updates, rental turnovers, and multi-trade punch lists with one point of contact.</p>
...
<h2>Handyman renovations vs. full general contracting</h2>
<p>We are not positioning Knight Group as a large GC for permitted structural additions. We are the right call when you want a reliable local team for occupied-home updates, rental turns, and smaller renovation scopes where communication and finish quality matter more than a giant subcontractor roster.</p>
""",
    "doors-windows": """
...
<p>When a job does not fit a single trade page — custom shelving, mantels, accent walls, or specialty install work — Knight Group scopes it under <strong>custom projects</strong>. We also route true furniture and resin art inquiries separately from everyday handyman repair.</p>
...
EXTRA_FAQ = {
    ...
    "general-repairs": [
        ...
        ("Can you install gutters in Safety Harbor?", "We handle gutter section replacement, re-hanging, pitch correction, and related fascia repairs. Full new gutter systems are quoted after on-site measurement."),
    ],
    "handyman": [
        ("What does a handyman company in Pinellas County typically charge?", "Knight Group uses clear written estimates. Many jobs start around $150 for the first hour with additional time billed at published rates — see our pricing page for detail."),
    ...
    "home-renovations": [
        ("What size renovation projects do you take on?", "We focus on smaller renovations: bathroom refreshes, laundry updates, rental turns, and multi-trade room updates — not large permitted additions."),
