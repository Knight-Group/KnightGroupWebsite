...
def legacy_fallback(path: str) -> str:
    fallbacks = {
        ...
        "service-areas.html": "Handyman service areas across Pinellas, Hillsborough, and west Pasco — including Temple Terrace. Lutz / North Tampa by confirmation. No storefront offices.",
    }
